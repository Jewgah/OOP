...
public class TestGraphAlgo {
   ...
   // test3();
    ...
    private static void test1() {
        ...
        graph.connect(4,1);
        graph.connect(4,3);
        System.out.println("after connecting the nodes in the graph");
        for (node_data n : graph.getV()){
    ...
    private static void test2() {
        ...
        graph.connect(8,5);
        graph.connect(9,4);
        System.out.println("after connect the nodes in the graph");
        for (node_data n : graph.getV()){
            System.out.println("key "+n.getKey()+" Ni --> " + n.getNi());
        }
        algo = new Graph_Algo();
...
//        System.out.println("test g: "+g.toString());
//        System.out.println("test gra: "+gra.toString());
        gra.init(g);
//        System.out.println("gra.init(g)");
//        System.out.println("test g: "+g.toString());
//        System.out.println("test gra: "+gra.toString());
